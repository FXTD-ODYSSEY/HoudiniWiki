hljs.registerLanguage('vex',function(hljs){var IDENT_RE='[A-Za-z$_][0-9A-Za-z$_]*';var NUMBERS={className:'vex_number',variants:[{begin:'\\b(0b[01\']+)'},{begin:'(-?)\\b([\\d\']+(\\.[\\d\']*)?|\\.[\\d\']+)(u|U|l|L|ul|UL|f|F|b|B)'},{begin:'(-?)(\\b0[xX][a-fA-F0-9\']+|(\\b[\\d\']+(\\.[\\d\']*)?|\\.[\\d\']+)([eE][-+]?[\\d\']+)?)'}],relevance:0};var SUBST={className:'vex_subst',begin:'\\$\\{',end:'\\}',contains:[]};var STRING={className:'vex_string',variants:[{begin:'(u8?|U)?L?"',end:'"',illegal:'\\n',contains:[hljs.BACKSLASH_ESCAPE]},{begin:'(u8?|U)?R"',end:'"',contains:[hljs.BACKSLASH_ESCAPE]},{begin:'\'\\\\?.',end:'\'',illegal:'.'}]};SUBST.contains=[STRING,NUMBERS,]
var PARAMS_CONTAINS=SUBST.contains.concat([hljs.C_BLOCK_COMMENT_MODE,hljs.C_LINE_COMMENT_MODE]);var TITLE={className:'vex_title',begin:hljs.UNDERSCORE_IDENT_RE,relevance:0};return{name:'vex',aliases:['Vex','vex'],keywords:{vex_built_in:'abs accessframe acos addattrib addattribute adddetailattrib addgroup addpoint addpointattrib '+
...
'writepixel wt_nspace wt_space wt_vspace xnoise xnoised xyzdist xyztorgb',vex_type:'int string float vector2 vector vector4 matrix2 matrix3 matrix bsdf light material',vex_context:'chop cop2 cvex displacement fog image3d light pop shadow sop surface',vex_operator:'\b(break continue do else foreach forpoints for function gather if illuminance import(?!\s*\() return while)\b'},illegal:'</',contains:[STRING,{className:'vex_variable',begin:'[isfv][\\@](\\^\\w\\b|#\\w+|[^\\s\\w{]|{\\w+}|\\w+)'},{className:'vex_function',begin:'function',end:/\{/,excludeEnd:true,contains:[hljs.inherit(TITLE,{begin:IDENT_RE}),{className:'params',begin:/\(/,end:/\)/,excludeBegin:true,excludeEnd:true,contains:PARAMS_CONTAINS}],illegal:/\[|%/},{className:'vex_comment',begin:'/\\*',end:'\\*/',contains:['self']},{className:'vex_comment',begin:'\/\/',end:'\n',contains:['self']},NUMBERS]};});